 ...
 * 
 */
public class LCCMetricTable extends MetricsTable {

	private static final String[] columnNames = new String[] { "Component", "LCC", "Assigned_Concerns"};
	
	private Set<LCCForComponent> lccMeasurements = new TreeSet<LCCForComponent>();
	
	public LCCMetricTable() {
		super(columnNames);
	}
