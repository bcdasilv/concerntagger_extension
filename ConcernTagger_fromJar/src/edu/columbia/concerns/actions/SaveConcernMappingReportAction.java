...
public class SaveConcernMappingReportAction extends Action {
	private MetricsTable metricsTable;
	private String suggestedPrefix = "";
	
	public SaveConcernMappingReportAction(MetricsTable metricsTable)
	{
		this.metricsTable = metricsTable;

		setText(ConcernTagger
				.getResourceString("actions.SaveConcernMappingReportAction.Label"));
		setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(
				ConcernTagger.ID_PLUGIN, "icons/action_save.gif"));
		setToolTipText(ConcernTagger
				.getResourceString("actions.SaveConcernMappingReportAction.ToolTip"));
	}
	...
	public void run()
	{
		String fileExt = ConcernTagger.getResourceString("actions.SaveConcernMappingReportAction.FileExt");
		...
		fileSaveDialog.setText(ConcernTagger
				.getResourceString("actions.SaveConcernMappingReportAction.DialogTitle"));
		fileSaveDialog.setFilterNames(new String[] { ConcernTagger
				.getResourceString("actions.SaveConcernMappingReportAction.DialogFilterName"),
				"All Files (*.*)"});
